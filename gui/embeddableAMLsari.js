...
function PrepareIframe() {
    $.ajax({
          url:"https://europe-west1-idetect-252605.cloudfunctions.net/has_configuration_site",
        ...
        success: function (data) {
            ...
            if (data == "true")
                ...
                iframe.src = "https://storage.cloud.google.com/idetect-252605.appspot.com/installsari.html?folder&organizationId";
            }
        }
    });
}
...
function sendImage(imageToSend) {
    setFieldsToEmpty();
    $.ajax({
        url:"https://europe-west1-idetect-252605.cloudfunctions.net/detect_type",
        //url:"https://europe-west1-idetect-252605.cloudfunctions.net/detect_type_card",
...
function putDataIntoFields(idFields, textFields) {
    ...
    for (k in idFields) {
        ...
        if (currentElement != undefined && textFields[k] != undefined && currentElement != null && textFields[k] != null)
            ...
            else if ((idFields[k]).type == "dict" && k == 'xxx') {
